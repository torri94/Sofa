...
******************************************************************************/
#include <Dani/MyMappingPendulumInPlane.inl>
...
template class SOFA_DANI_API MyMappingPendulumInPlane<Vec1Types, Vec3Types>;
template class SOFA_DANI_API MyMappingPendulumInPlane<Vec1Types, Vec2Types>;
