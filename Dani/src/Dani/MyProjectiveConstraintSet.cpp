...
******************************************************************************/
#include <Dani/MyProjectiveConstraintSet.inl>
...
template class SOFA_DANI_API MyProjectiveConstraintSet<Rigid3Types>;
template class SOFA_DANI_API MyProjectiveConstraintSet<Vec3Types>;
